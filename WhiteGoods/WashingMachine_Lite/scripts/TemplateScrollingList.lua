...
function CBFillTable(mapargs) 
  ...
  --table 5
  for i=1, 60 do
    data["dateLayer.minute.backgroundTable.text."..i..".1"] = i
    data["dateLayer.minute.foregroundTable.text."..i..".1"] = i
    local j = i+60
    data["dateLayer.minute.backgroundTable.text."..j..".1"] = i
    data["dateLayer.minute.foregroundTable.text."..j..".1"] = i
    local k = i+120
    data["dateLayer.minute.backgroundTable.text."..k..".1"] = i
    data["dateLayer.minute.foregroundTable.text."..k..".1"] = i
  end
...
function CBSetupDateTable(mapargs)
  ...
  setDateForegroundLocation(yoffset)
...
function CBSetupMonthTable(mapargs)
  ...
  setMonthForegroundLocation(yoffset)
...
function CBSetupYearTable(mapargs)
  ...
  setYearForegroundLocation(yoffset)
...
function CBSetupHourTable(mapargs)
  ...
  setHourForegroundLocation(yoffset)
...
function CBSetupMinuteTable(mapargs)
  ...
  setMinuteForegroundLocation(yoffset)
