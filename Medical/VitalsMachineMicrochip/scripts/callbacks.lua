...
function navigatePress(mapargs)
    ...
    animationContext = mapargs.context_group

end

function navigatePressAnimate(mapargs)
    local data = {}
    data.context = animationContext
...
--function updateCPU(mapargs)
--  local cpu_update = {}
--  cpu_update["cpu_usage"] = tostring(gre.get_cpu_usage()) .. "%"; 
--  gre.set_data(cpu_update)
--end
...
--    numTimer = gre.timer_set_interval(update_numbers,750)
--    end
--end
--
...
--          gre.timer_clear_interval(numTimer)
--          trends_timer = nil
--          numTimer = nil
--          --print("clearTrends")
--       end
