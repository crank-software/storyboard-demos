...
function MOVIESCREEN_SelectMovie(mapargs)
  ...
  if(movie==1)then
    ...
    movieTrailer = "trailers/pacificRim.mp4"
  elseif(movie==2)then
    ...
    movieTrailer = "trailers/tronLegacy.mp4"
  elseif(movie==3)then
    ...
    movieTrailer = "trailers/starWars.mp4"
  elseif(movie==4)then
    ...
    movieTrailer = "trailers/insideOut.mp4"
  elseif(movie==5)then
    ...
    movieTrailer = "trailers/madMax.mp4"
  elseif(movie==6)then
    ...
    movieTrailer = "trailers/FuriousSeven.mp4"
  elseif(movie==7)then
    ...
    movieName = "Mission Impossible: Rogue Nation"
    movieRuntime = "131 min"
    movieTrailer = "trailers/MI.mp4"
  elseif(movie==8)then
    ...
    movieName = "BvS: Dawn Of Justice"
    movieRuntime = "118 min"
    movieTrailer = "trailers/BvS.mp4"
  elseif(movie==9)then
    ...
    movieName = "Zootopia"
    movieRuntime = "108 min"
    movieTrailer = "trailers/zootopia.mp4"
  end
...
function APP_resetApp(mapargs)
  ...
  gre.set_control_attrs(prevSelectedMovie..".openStars",dataTable)
