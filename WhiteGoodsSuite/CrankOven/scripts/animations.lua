function anim_HomeLayerSnap(fromPos, toPos, midFromPos, midToPos)
  ...
  local homeLayerSnap = gre.animation_create(60, 1)
...
function anim_cookModesBannerFade(incNew, incPrev)
  ...
  local homeBannerFade = gre.animation_create(60, 1)
...
function anim_preheatOuterArc(ctrlHeight, preheatHeight)
  ...
  local preheatArc = gre.animation_create(60, 1)
...
function create_voiceAnim()
  loopingVoiceLines = gre.animation_create(60, 0, triggerVoiceLinesAnim)
  loopingVoiceDots = gre.animation_create(60, 0, triggerVoiceDotsAnim)
end
...
function anim_homeExtras()
  ...
  homeExtrasAnimation = gre.animation_create(60, 0, callExtrasAnimation)
  anim_data["rate"] = "linear"
...
function createForwardAnimations()
  for i = 1, 10 do
    anim_BackSecOne[i] = gre.animation_create(60, 0)
    anim_BackSecTen[i] = gre.animation_create(60, 0)
    
    anim_BackMinOne[i] = gre.animation_create(60, 0)
    anim_BackMinTen[i] = gre.animation_create(60, 0)
    
    anim_BackHourOne[i] = gre.animation_create(60, 0)
    anim_BackHourTen[i] = gre.animation_create(60, 0)
  end
  
  anim_BackSecLoop = gre.animation_create(60, 0)
  anim_BackMinLoop = gre.animation_create(60, 0)
end

function createTempAnimations()
  for i = 1, 10 do
    anim_ForTempHun[i] = gre.animation_create(60, 0)
    anim_ForTempTen[i] = gre.animation_create(60, 0)
    anim_ForTempOne[i] = gre.animation_create(60, 0)
    
    anim_BackTempHun[i] = gre.animation_create(60, 0)
    anim_BackTempTen[i] = gre.animation_create(60, 0)
    anim_BackTempOne[i] = gre.animation_create(60, 0)
  end
  
  anim_FiveToZero = gre.animation_create(60, 0)
  anim_ZeroToFive = gre.animation_create(60, 0)
