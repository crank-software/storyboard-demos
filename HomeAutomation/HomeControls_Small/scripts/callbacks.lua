...
function cb_load_images(mapargs) 
    ...
    gre.load_image("images/crank_storyboard.png")
    gre.load_image("images/climate_box_rain.png")
    gre.load_image("images/armed_bg.png")
    gre.load_image("images/lig_bg_570x420.png")
    gre.load_image("images/floorplan1.png")
    gre.load_image("images/menu_climate.png")
